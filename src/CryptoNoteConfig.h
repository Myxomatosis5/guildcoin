...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0xc5d7f; //addresses start with "jmsm"
...
const int      RPC_DEFAULT_PORT                              = 28434;
...
const std::initializer_list<const char*> SEED_NODES = {
  "seedone.guildaero.space:18770",
  "seedtwo.guildaero.space:18770",
  "seedthree.guildaero.space:18770",
};
